...
export default function ApiBar() {
  ...
  if (IS_READ_ONLY) {
    return (
      <div className="bg-sidebar border-b border-white/[0.07] px-4 md:px-8 py-2 flex items-center gap-3">
  ...
  return (
    <div className="bg-sidebar border-b border-white/[0.07] px-4 md:px-8 py-2 flex items-center gap-3 flex-wrap">
      {/* API key */}
