...
export default function MonthlyReportsPage() {
  ...
  // Seed from the first NON-archived batch — auto-selecting a retired cohort would
  // silently scope the default report to a batch nobody teaches any more.
  const [batch, setBatch] = useState(
    () => (syllabusBatches || []).find(b => !(archivedBatches || []).includes(b)) || ''
  )
