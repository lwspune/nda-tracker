...
import { quizCohort, quizSummary, quizQuestionStats, quizNotAttempted } from '../../lib/quizStats'
    ...
    <div className="max-w-3xl">
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          ...
          {/* Attempted students */}
          <Card>
            <div className="text-[11px] font-bold text-ink-3 uppercase tracking-wide mb-2">Attempted ({sortedAttempts.length})</div>
            <div className="divide-y divide-border">
              {sortedAttempts.map(a => (
                <div key={a.lwsId} className="py-2 flex items-center gap-3 text-[13px]">
                  ...
                  <div className="text-ink-3 font-mono text-[11px]">{a.correct}/{quiz.questions.length} correct</div>
