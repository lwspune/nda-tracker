...
Test files mirror source paths under `__tests__/`. Python tests under `tests/`. **1160 Vitest tests passing** (2026-06-01, full `vitest run`: 68 files). **39 Python tests** in `tests/test_subtopic_merge.py`. For test-infrastructure detail (mock patterns, growth log, chainable Supabase builder) see memory `project_testing.md`.
