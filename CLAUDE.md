...
`src/pages/Settings/SettingsPage.jsx` is admin-only and the **only** place branches, batches, and teachers can be added / renamed / deleted. Five tabs:
...
| Settings page (Branches / Batches / Teachers / NDA Weightage / Monitoring) | ✓ | — | — |
...
| `src/pages/Settings/` | Admin-only Settings page (`SettingsPage`, `BranchesTab`, `BatchesTab`, `TeachersTab`, `NdaWeightageTab`, `MonitoringTab`) |
