...
- Any mock store rendering the Lecture log tab (`LectureLogTab.test.jsx`, `AttendancePage.test.jsx`) must include `timetableTeachers: []`, `submitLecture`, `getSubmissionsForDate` — `FilingBoard` reads all three at mount.
